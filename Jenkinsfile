pipeline {
    ...
    environment {
        ...
        DEPLOY_HOST = "54.179.177.73"  // Ganti dengan IP instance AWS-mu
        SSH_CREDENTIALS_ID = "gibran_ssh"  // ID credential SSH di Jenkins
        APP_DIR = "/home/ec2-user/app/devops"
        GIT_REPO = "https://github.com/Gibransyah/devops.git"
    }
...
/* dibawah ini adalah konfigurasi CI pipeline NO 2
pipeline {
    agent any
